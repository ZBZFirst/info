...
<style>
    ...
    <script>
        ...
        function update() {
            ...
            // Only update the traces that need changing (not the entire plot)
            Plotly.react('graph', {
                data: [
                    graphData.pCO2Lines[0], // First trace (heatmap)
                    ...graphData.pCO2Lines.slice(1), // Other traces
                    {
                        x: circlePoints.pH_values,
                        y: circlePoints.hco3_values,
                        mode: 'lines',
