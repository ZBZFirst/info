...
<div class="landing-grid-container">
  ...
  <div class="grid-3x3">
    ...
    <!-- Grid Item 3 -->
    <a href="/OpenSourceWaveforms.html/" class="grid-item" data-grid-item="3">
      <div class="grid-icon">📖</div>
    ...
    <!-- Grid Item 9 -->
    <a href="/info/simulation.html" class="grid-item" data-grid-item="10">
      <div class="grid-icon">🧪</div>
      ...
      <span class="grid-url">/info/simulation.html</span>
    </a>
  </div>
